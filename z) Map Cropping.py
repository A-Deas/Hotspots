...
image_set = 'Hotspot Accuracy Maps'

def get_image(image_set, dataset, year):
    if image_set == 'Error Histograms':
        img_path = f'Images/{image_set}/{dataset}/{year} {dataset} Error Histogram.png'
...
def save_cropped_image(cropped_img, image_set, dataset, year):
    if image_set == 'Error Histograms':
        output_img_path = f'/Users/deas/Documents/Research/Paper 1/Cropped images for paper/{dataset}/{year} {dataset} Error Histogram.png'
    elif image_set == 'Accuracy Maps':
